...
object TeamLeaderCommand: ITeamCommand(TeamCommandCategory.LEADER, "leader") {
    override val usage: String = "/t leader <player>"
    override val description: String = "Transfer the team to another player"
    ...
    override val commandCallback: LiteralArgumentBuilder<CommandSourceStack>.() -> Unit = {
        argument<String>("member") {
            ...
            runs {
                ...
                team.transfer(teamPlayer, target)
            }
        }
